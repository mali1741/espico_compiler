...
char eatx,eaty;
char snake_length;
char snake_spr[] = {0x66,0x60,0x6,0x60,0x66,0x60};
char eat_spr[] = {0x88,0x80,0x88,0x80,0x88,0x80};
char snake_clr[] = {0x55,0x50,0x55,0x50,0x55,0x50};
char snake_dir;
int i,key, game_end;
...
void action(){
	...
	if(getpix(snake[0] * 3 + 1, snake[1] * 3 + 1) == 1)
		game_end = 1; 
